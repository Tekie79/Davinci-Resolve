...
class CapabilityDetector:
    ...
    def detect(self, context):
        ...
        return {
            ...
            "speaker_segment_read": Capability(False, "Resolve's documented scripting API does not expose transcription speaker segments; inject an analyzer adapter or precomputed segments."),
