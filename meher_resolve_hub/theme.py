...
TREE = "QTreeWidget{background:#141416;color:#FFFFFF;border:1px solid #2C2C32;alternate-background-color:#18181B;}QTreeWidget QHeaderView::section{background:#1E1E21;color:#A7A7AD;border:0;border-bottom:1px solid #2C2C32;padding:7px 5px;min-height:28px;font-weight:700;}QTreeWidget::item{padding:5px;}QTreeWidget::item:selected,QTreeWidget::item:selected:!active{background:#3A3A40;border:0;}"
MARKER_TREE = TREE + "QTreeWidget QLineEdit{background:#0B0B0C;color:#FFFFFF;border:2px solid #C58A35;border-radius:4px;padding:3px;selection-background-color:#B77924;selection-color:#FFFFFF;}"
